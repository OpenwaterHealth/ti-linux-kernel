				       ...
				       struct drm_connector *connector)
{
	if (!mhdp->plugged)
		...
		u64 *edid_arr = kmalloc(EDID_LENGTH, GFP_KERNEL);   
		unsigned char source_arr[]={
			...
			0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x9e, 0x20,
			0x00, 0x80, 0x50, 0x20, 0x0a, 0x30, 0x20, 0x50,
			0x36, 0x00, 0x4d, 0xd0, 0x10, 0x00, 0x00, 0x18,
			0x00, 0x00, 0x00, 0xff, 0x00, 0x4c, 0x69, 0x6e,
			0x75, 0x78, 0x20, 0x23, 0x30, 0x0a, 0x20, 0x20,
			0x20, 0x20, 0x00, 0x00, 0x00, 0xfd, 0x00, 0x3b,
			0x3d, 0x3a, 0x3c, 0x09, 0x00, 0x0a, 0x20, 0x20,
			0x20, 0x20, 0x20, 0x20, 0x00, 0x00, 0x00, 0xfc,
			0x00, 0x4c, 0x69, 0x6e, 0x75, 0x78, 0x20, 0x57,
			0x58, 0x47, 0x41, 0x0a, 0x20, 0x20, 0x00, 0x5b,
		};      
															
		memcpy(edid_arr, source_arr, sizeof(source_arr));
		return (struct edid *)edid_arr;
	}
